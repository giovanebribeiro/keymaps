 ...
 *                  |------+------+------+------+------+------+------+------+------+------+------+------|
 *                  | Game |  F9  |  F10 |  F11 |  F12 |      |      |  |   |   1  |   2  |   3  |PrtScr|
 *                  |------+------+------+------+------+------+------+------+------+------+------+------|
 *                  |  Tab | Home |  ¢   |  -_  |Lower |  Backspace  |Raise | =+ § |  '"  |  End | KBRD | ------> Tap to Caps Lock
 *                  `-----------------------------------------------------------------------------------'
 *
...
/* Game (just the directionals and all F buttons for customization)
 *
 *                  ,-----------------------------------------------------------------------------------.
 *                  |      |     |   ↑  |      |      |      |      |  F1  |  F2  |  F3  |  F4  |  F5   | 
 *                  |------+-----+------+------+------+------+------+------+------+------+------+-------|
...
/*[GAME_LAYER] = LAYOUT_planck_grid_wrapper(
    XXXXXXX, __________________GAME_L1___________________, __________________GAME_R1___________________, KC_F5,
    XXXXXXX, __________________GAME_L2___________________, __________________GAME_R2___________________, KC_F10,
    XXXXXXX, __________________GAME_L3___________________, __________________GAME_R3___________________, KC_F15,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_F16,  KC_F17,   KC_F18,   KC_F19, KC_F20
)*/
