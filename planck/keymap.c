 ...
 *                  |------+------+------+------+------+------+------+------+------+------+------+------|
 *                  |  Tab | Home |  ¢   |  -_  |Lower |  Backspace  |Raise |  00  |   0  |  End | KBRD | ------> Tap to Caps Lock
 *                  `-----------------------------------------------------------------------------------'
 *
 */
 ...
 *                  |      | F11 |  F10 |  F9  |  F8  |  F7  |      |      |      |      |      |       | 
 *                  |------+-----+------+------+------+------+------+------+------+------+------+-------|
 *                  |      |     |  Alt | Shift| Ctrl |    Space    |  F19 |  F20 |      |      | KBRD  | 
 *                  `-----------------------------------------------------------------------------------'
 *                         
 */
[GAME_LAYER] = LAYOUT_planck_grid_wrapper(
    ...
    XXXXXXX, XXXXXXX, KC_LOPT, KC_LSFT, KC_LCTL,  KC_SPC,  KC_SPC,  KC_F19, XXXXXXX, XXXXXXX, XXXXXXX,    KBRD
),
