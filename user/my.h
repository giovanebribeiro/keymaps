...
// Game layer
#define __________________GAME_L1__________________ _______, _______, _______, _______,   KC_F5
#define __________________GAME_L2__________________ KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT,   KC_F6
#define __________________GAME_L3__________________  KC_F11,  KC_F10,   KC_F9,   KC_F8,   KC_F7

#define __________________GAME_R1__________________ _______, _______, _______, _______, _______
#define __________________GAME_R2__________________ _______, _______, _______, _______, _______
#define __________________GAME_R3__________________ _______, _______, _______, _______, _______
